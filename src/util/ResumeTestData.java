...
public class ResumeTestData {
    ...
    public static Resume getTestData() {
        ...
        resumeTestData.getSectionsMap().put(SectionType.EXPERIENCE, new CompanySection(experiences));
        ...
        educations.add(new Company("Заочная физико-техническая школа при МФТИ",
                ...
                new Position(1984,
                        ...
                        "Закончил с отличием",
                        "")));
        resumeTestData.getSectionsMap().put(SectionType.EDUCATION, new CompanySection(educations));
